            ...
            <div className="login-page__left">
                ...
                <form onSubmit={_handleSubmit}>
                    <div className="input-wrapper">
                        <input type="text" placeholder="Identifier ( ex: me.bsky.social )" value={form.identifier} onChange={e => setForm(prev => ({ ...prev, identifier: e.target.value }))} />
                    </div>
                    <div className="input-wrapper">
                    ...
                    <p style={{textAlign:"center"}}>Teal requires an existing <a href="https://blueskyweb.xyz//">Bluesky </a>account</p>
                </form>
            </div>
        </div>
