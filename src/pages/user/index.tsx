...
export default function User(props: { user: any; likes: any; posts: any; media: any }) {
          ...
          <>
            ...
            <div className={styles.tabs}>
              <button
                ...
                className={cn(styles.tab, { [styles.active]: tab == 'posts' })}
              >
                Posts
              </button>
              <button
                ...
                className={cn(styles.tab, { [styles.active]: tab == 'replies' })}
              >
                Replies
              </button>
              <button
                ...
                className={cn(styles.tab, { [styles.active]: tab == 'likes' })}
              >
                Likes
              </button>
              <button
                ...
                className={cn(styles.tab, { [styles.active]: tab == 'media' })}
              >
                Media
              </button>
            </div>
