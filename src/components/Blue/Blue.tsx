...
export default function Blue(props: {
    ...
    return (
        !post ? <p>Not Found</p> : <>
            <div ref={elementRef} className={cn(styles.blue, className, { [styles.isReply]: isReply, [styles.parent]: isParent, [styles.single]: isSingle })} onClick={_handleClick} onMouseDown={e => _handleClick(e, true)}>
